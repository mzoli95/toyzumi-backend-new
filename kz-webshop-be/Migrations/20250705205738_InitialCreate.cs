        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Franchise = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    FunkoPop_IsLimitedEdition = table.Column<bool>(type: "bit", nullable: true),
                    FunkoPop_IsPreorder = table.Column<bool>(type: "bit", nullable: true),
                    FunkoPop_IsUsed = table.Column<bool>(type: "bit", nullable: true),
                    Series = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Edition = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    IsLimitedEdition = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FunkoPopTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FunkoPopTags_Product_FunkoPopId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedToType = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RelatedProducts", x => new { x.ProductId, x.RelatedToId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_RelatedProducts_Product_RelatedToId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyBankAccount = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FunkoPopTags_FunkoPopId",
                table: "FunkoPopTags",
                column: "FunkoPopId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_Edition",
                table: "Product",
                column: "Edition");

            migrationBuilder.CreateIndex(
                name: "IX_Product_Franchise",
                table: "Product",
                column: "Franchise");
